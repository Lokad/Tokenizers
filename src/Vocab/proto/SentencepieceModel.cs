...
namespace Lokad.Tokenizers.Vocab {
  ...
  public static partial class SentencepieceModelReflection {
    ...
    static SentencepieceModelReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            "ChlzZW50ZW5jZXBpZWNlX21vZGVsLnByb3RvEg1zZW50ZW5jZXBpZWNlIqEK",
            ...
            "IgoSY2hhcmFjdGVyX2NvdmVyYWdlGAogASgCOgYwLjk5OTUSHgoTaW5wdXRf",
            "c2VudGVuY2Vfc2l6ZRgLIAEoBDoBMBIkChZzaHVmZmxlX2lucHV0X3NlbnRl",
            "bmNlGBMgASgIOgR0cnVlEiAKFG1pbmluZ19zZW50ZW5jZV9zaXplGAwgASgF",
            "QgIYARIiChZ0cmFpbmluZ19zZW50ZW5jZV9zaXplGA0gASgFQgIYARIoChdz",
            "ZWVkX3NlbnRlbmNlcGllY2Vfc2l6ZRgOIAEoBToHMTAwMDAwMBIeChBzaHJp",
            "bmtpbmdfZmFjdG9yGA8gASgCOgQwLjc1EiEKE21heF9zZW50ZW5jZV9sZW5n",
            "dGgYEiABKAU6BDQxOTISFwoLbnVtX3RocmVhZHMYECABKAU6AjE2Eh0KEm51",
            "bV9zdWJfaXRlcmF0aW9ucxgRIAEoBToBMhIkChhtYXhfc2VudGVuY2VwaWVj",
            "ZV9sZW5ndGgYFCABKAU6AjE2EiUKF3NwbGl0X2J5X3VuaWNvZGVfc2NyaXB0",
            "GBUgASgIOgR0cnVlEh0KD3NwbGl0X2J5X251bWJlchgXIAEoCDoEdHJ1ZRIh",
            "ChNzcGxpdF9ieV93aGl0ZXNwYWNlGBYgASgIOgR0cnVlEikKGnRyZWF0X3do",
            "aXRlc3BhY2VfYXNfc3VmZml4GBggASgIOgVmYWxzZRIbCgxzcGxpdF9kaWdp",
            "dHMYGSABKAg6BWZhbHNlEhcKD2NvbnRyb2xfc3ltYm9scxgeIAMoCRIcChR1",
            "c2VyX2RlZmluZWRfc3ltYm9scxgfIAMoCRIWCg5yZXF1aXJlZF9jaGFycxgk",
            "IAEoCRIcCg1ieXRlX2ZhbGxiYWNrGCMgASgIOgVmYWxzZRIrCh12b2NhYnVs",
            "YXJ5X291dHB1dF9waWVjZV9zY29yZRggIAEoCDoEdHJ1ZRIeChBoYXJkX3Zv",
            "Y2FiX2xpbWl0GCEgASgIOgR0cnVlEhwKDXVzZV9hbGxfdm9jYWIYIiABKAg6",
            "BWZhbHNlEhEKBnVua19pZBgoIAEoBToBMBIRCgZib3NfaWQYKSABKAU6ATES",
            "EQoGZW9zX2lkGCogASgFOgEyEhIKBnBhZF9pZBgrIAEoBToCLTESGAoJdW5r",
            "X3BpZWNlGC0gASgJOgU8dW5rPhIWCglib3NfcGllY2UYLiABKAk6AzxzPhIX",
            "Cgllb3NfcGllY2UYLyABKAk6BDwvcz4SGAoJcGFkX3BpZWNlGDAgASgJOgU8",
            "cGFkPhIaCgt1bmtfc3VyZmFjZRgsIAEoCToFIOKBhyASKwocdHJhaW5fZXh0",
            "cmVtZWx5X2xhcmdlX2NvcnB1cxgxIAEoCDoFZmFsc2UiNQoJTW9kZWxUeXBl",
            "EgsKB1VOSUdSQU0QARIHCgNCUEUQAhIICgRXT1JEEAMSCAoEQ0hBUhAEKgkI",
            "yAEQgICAgAIi0QEKDk5vcm1hbGl6ZXJTcGVjEgwKBG5hbWUYASABKAkSHAoU",
            "cHJlY29tcGlsZWRfY2hhcnNtYXAYAiABKAwSHgoQYWRkX2R1bW15X3ByZWZp",
            "eBgDIAEoCDoEdHJ1ZRImChhyZW1vdmVfZXh0cmFfd2hpdGVzcGFjZXMYBCAB",
            "KAg6BHRydWUSIAoSZXNjYXBlX3doaXRlc3BhY2VzGAUgASgIOgR0cnVlEh4K",
            "Fm5vcm1hbGl6YXRpb25fcnVsZV90c3YYBiABKAkqCQjIARCAgICAAiJ5CgxT",
            "ZWxmVGVzdERhdGESMwoHc2FtcGxlcxgBIAMoCzIiLnNlbnRlbmNlcGllY2Uu",
            "U2VsZlRlc3REYXRhLlNhbXBsZRopCgZTYW1wbGUSDQoFaW5wdXQYASABKAkS",
            "EAoIZXhwZWN0ZWQYAiABKAkqCQjIARCAgICAAiL+AwoKTW9kZWxQcm90bxI3",
            "CgZwaWVjZXMYASADKAsyJy5zZW50ZW5jZXBpZWNlLk1vZGVsUHJvdG8uU2Vu",
            "dGVuY2VQaWVjZRIwCgx0cmFpbmVyX3NwZWMYAiABKAsyGi5zZW50ZW5jZXBp",
            "ZWNlLlRyYWluZXJTcGVjEjYKD25vcm1hbGl6ZXJfc3BlYxgDIAEoCzIdLnNl",
            "bnRlbmNlcGllY2UuTm9ybWFsaXplclNwZWMSMwoOc2VsZl90ZXN0X2RhdGEY",
            "BCABKAsyGy5zZW50ZW5jZXBpZWNlLlNlbGZUZXN0RGF0YRI4ChFkZW5vcm1h",
            "bGl6ZXJfc3BlYxgFIAEoCzIdLnNlbnRlbmNlcGllY2UuTm9ybWFsaXplclNw",
            "ZWMa0gEKDVNlbnRlbmNlUGllY2USDQoFcGllY2UYASABKAkSDQoFc2NvcmUY",
            "AiABKAISQgoEdHlwZRgDIAEoDjIsLnNlbnRlbmNlcGllY2UuTW9kZWxQcm90",
  ...
  public sealed partial class TrainerSpec : pb::IExtendableMessage<TrainerSpec>
  ...
  #endif
  {
    ...
    public bool ByteFallback {
      get { if ((_hasBits0 & 4194304) != 0) { return byteFallback_; } else { return ByteFallbackDefaultValue; } }
      set {
        _hasBits0 |= 4194304;
        byteFallback_ = value;
      }
    ...
    public bool VocabularyOutputPieceScore {
      get { if ((_hasBits0 & 524288) != 0) { return vocabularyOutputPieceScore_; } else { return VocabularyOutputPieceScoreDefaultValue; } }
      set {
        _hasBits0 |= 524288;
    ...
    public bool HardVocabLimit {
      get { if ((_hasBits0 & 1048576) != 0) { return hardVocabLimit_; } else { return HardVocabLimitDefaultValue; } }
      set {
        _hasBits0 |= 1048576;
    ...
    public bool UseAllVocab {
      get { if ((_hasBits0 & 2097152) != 0) { return useAllVocab_; } else { return UseAllVocabDefaultValue; } }
      set {
        _hasBits0 |= 2097152;
        useAllVocab_ = value;
      }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public int UnkId {
      get { if ((_hasBits0 & 8388608) != 0) { return unkId_; } else { return UnkIdDefaultValue; } }
      set {
        _hasBits0 |= 8388608;
        unkId_ = value;
      }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public int BosId {
      get { if ((_hasBits0 & 16777216) != 0) { return bosId_; } else { return BosIdDefaultValue; } }
      set {
        _hasBits0 |= 16777216;
        bosId_ = value;
      }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public int EosId {
      get { if ((_hasBits0 & 33554432) != 0) { return eosId_; } else { return EosIdDefaultValue; } }
      set {
        _hasBits0 |= 33554432;
        eosId_ = value;
      }
    ...
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public int PadId {
      get { if ((_hasBits0 & 67108864) != 0) { return padId_; } else { return PadIdDefaultValue; } }
      set {
        _hasBits0 |= 67108864;
        padId_ = value;
      }
    ...
    public bool TrainExtremelyLargeCorpus {
      get { if ((_hasBits0 & 134217728) != 0) { return trainExtremelyLargeCorpus_; } else { return TrainExtremelyLargeCorpusDefaultValue; } }
      set {
        _hasBits0 |= 134217728;
  ...
  /// </summary>
  [global::System.Diagnostics.DebuggerDisplayAttribute("{ToString(),nq}")]
  public sealed partial class NormalizerSpec : pb::IExtendableMessage<NormalizerSpec>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
  ...
  /// </summary>
  [global::System.Diagnostics.DebuggerDisplayAttribute("{ToString(),nq}")]
  public sealed partial class SelfTestData : pb::IExtendableMessage<SelfTestData>
  #if !GOOGLE_PROTOBUF_REFSTRUCT_COMPATIBILITY_MODE
      , pb::IBufferMessage
  #endif
  {
